function user_setup()
	...
	state.Weapons:options('Chango','DualWeapons','Greatsword','ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ShiningOne','ProcGreatKatana','ProcClub','ProcStaff')
...
function init_gear_sets()
	...
	sets.precast.JA['Berserk'] = {body="Pummeler's Lorica +3",feet="Agoge Calligae +1",back="Cichol's Mantle"}
	...
	sets.precast.JA['Retaliation'] = {hands="Pummeler's Mufflers +1",feet="Ravager's Calligae +1"}
	sets.precast.JA['Restraint'] = {hands="Ravager's Mufflers +1"}
	sets.precast.JA['Blood Rage'] = {body="Ravager's Lorica +1"}
    ...
    hands={ name="Odyssean Gauntlets", augments={'Attack+25','Weapon skill damage +3%','VIT+11','Accuracy+3',}},
    legs={ name="Odyssean Cuisses", augments={'Mag. Acc.+1','Weapon skill damage +4%','VIT+10','Accuracy+3','Attack+14',}},
	...
	sets.precast.WS.SomeAcc = set_combine(sets.precast.WS, {neck="War. Beads +1"})
	sets.precast.WS.Acc = set_combine(sets.precast.WS, {neck="War. Beads +1"})
	sets.precast.WS.FullAcc = set_combine(sets.precast.WS, {neck="War. Beads +1"})
    ...
    legs={ name="Valor. Hose", augments={'Accuracy+17 Attack+17','Weapon skill damage +5%','STR+9','Accuracy+15','Attack+14',}},
    feet="Sulev. Leggings +2",
    neck="War. Beads +1",
    ...
    left_ring="Regal Ring",
    right_ring="Niqmaddu Ring",
    back={ name="Cichol's Mantle", augments={'VIT+20','Accuracy+20 Attack+20','VIT+9','"Weapon skill damage +10%',}},
	}
	...
	sets.engaged = {
		ammo="Ginsen",
		head="Flam. Zucchetto +2",
		body={ name="Valorous Mail", augments={'Attack+18','"Dbl.Atk."+5','AGI+3','Accuracy+13',}},
		hands="Sulev. Gauntlets +2",
		legs="Pumm. Cuisses +3",
		feet="Pumm. Calligae +3",
		neck="War. Beads +1",
