...
function get_sets()
    ...
    sub="Elan Strap",
    ammo="Sancus Sachet +1",
    head={ name="Helios Band", augments={'Pet: Accuracy+22 Pet: Rng. Acc.+22','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+6',}},
    body="Con. Doublet +2",
    hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+12 Pet: Rng. Acc.+12','Blood Pact Dmg.+10','Pet: Mag. Acc.+8',}},
    legs={ name="Apogee Slacks +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}},
    feet={ name="Helios Boots", augments={'Pet: Accuracy+19 Pet: Rng. Acc.+19','Pet: "Dbl. Atk."+6','Blood Pact Dmg.+5',}},
    neck="Smn. Collar +1",
    ...
    left_ring="Shneddick Ring",
		right_ring="Evoker's Ring",
    back={ name="Conveyance Cape", augments={'Summoning magic skill +5','Pet: Enmity+11','Blood Pact Dmg.+3','Blood Pact ab. del. II -2',}},
    }
    ...
    sets.avatar.mab = set_combine(sets.avatar.skill,{
		main={ name="Grioavolr", augments={'Blood Pact Dmg.+10','Pet: INT+15','Pet: Mag. Acc.+21','Pet: "Mag.Atk.Bns."+20','DMG:+6',}},
    sub="Elan Strap",
    ammo="Sancus Sachet +1",
    head={ name="Apogee Crown +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}},
    body="Con. Doublet +3",
    hands={ name="Merlinic Dastanas", augments={'Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+10','Pet: DEX+4',}},
